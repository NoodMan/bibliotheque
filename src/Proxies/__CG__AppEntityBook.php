...
class Book extends \App\Entity\Book implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'summary', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'author', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'editor', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'n_isbn', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'available', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'borrowed'];
        }
     ...
     * {@inheritDoc}
     */
    public function setBorrowed($borrowed): \App\Entity\Book
    {
     ...
     * {@inheritDoc}
     */
    public function setSummary(string $summary): \App\Entity\Book
    {
     ...
     * {@inheritDoc}
     */
    public function setAuthor(\App\Entity\User $author): \App\Entity\Book
    {
     ...
     * {@inheritDoc}
     */
    public function setEditor(\App\Entity\User $editor): \App\Entity\Book
    {
    ...
    public function getNIsbn(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNIsbn', []);

        return parent::getNIsbn();
    }

    /**
     * {@inheritDoc}
     */
    public function setNIsbn(int $n_isbn): \App\Entity\Book
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNIsbn', [$n_isbn]);

        return parent::setNIsbn($n_isbn);
    }

    /**
     * {@inheritDoc}
     */
    public function addNote(\App\Entity\Note $note): \App\Entity\Book
    {
     ...
     * {@inheritDoc}
     */
    public function removeNote(\App\Entity\Note $note): \App\Entity\Book
    {
     ...
     * {@inheritDoc}
     */
    public function setAvailable(int $available): \App\Entity\Book
    {
